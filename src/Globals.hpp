...
{
	{0, {NO_OPT, NO_OPT, NO_OPT, NO_OPT}, {NodeType::END_NODE, {0, 1}, {0, 0}, {0, 0}}, {0, 10, 0}, 0.05, 0, 1.1, "", "", "inc/Level.png"},
	...
	{1, {NO_OPT, NO_OPT, NO_OPT, NO_OPT}, {NodeType::END_NODE, {0, 0}, {0, 0}, {0, 0}}, {-90, 30, 0}, 0.75, 0, 90, "", "dB", "inc/Amplify.png"},
